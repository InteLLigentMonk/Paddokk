...
public class UploadJourneyCoverImageCommandValidatorTests
{
    private readonly UploadJourneyCoverImageCommandValidator _validator = new(new ImageUploadValidator());

    [Fact]
    public async Task Validate_ValidJpeg_Passes()
    {
        var command = new UploadJourneyCoverImageCommand(1, ImageUploadTestFiles.JpegFile());
    ...
    {
        var command = new UploadJourneyCoverImageCommand(1, ImageUploadTestFiles.PngFile());
    ...
    {
        var command = new UploadJourneyCoverImageCommand(1, ImageUploadTestFiles.WebpFile());
    ...
    public async Task Validate_OversizeFile_Fails()
    {
        ...
        var result = await _validator.ValidateAsync(new UploadJourneyCoverImageCommand(1, file));
