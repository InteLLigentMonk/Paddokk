...
/// <paramref name="BlobUri"/> is the unsigned blob URL persisted for cleanup; <paramref name="DownloadUrl"/>
/// is the time-limited SAS link emailed to the user and never stored at rest.
/// <para>
...
/// </para>
/// </summary>
public sealed record MarkExportCompleteCommand(Guid RequestId, string BlobUri, string DownloadUrl, DateTime ExpiresAt)
    : IRequest<Result>;
